          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Expanded card */}
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 border-white/20 shadow-2xl overflow-visible"
                    style={{ background: "rgba(9,10,15,0.95)", backdropFilter: "blur(16px)" }}>
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-px h-3 bg-indigo-500/60" />
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-md border-white/20 bg-transparent hover:bg-indigo-500/20 text-zinc-400 hover:text-white transition-all"

        ...
        <div className="min-h-screen bg-slate-50 py-24">
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto">Choose the plan that fits your business scale. No hidden fees. No complex contracts.</p>
                    ...
                    <div className="flex items-center justify-center gap-4 bg-white p-2 rounded-2xl border border-slate-200 w-fit mx-auto shadow-sm">
                        <button
                            className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${billingCycle === 'monthly' ? 'bg-slate-900 text-white shadow-lg' : 'text-slate-500'}`}
                            onClick={() => setBillingCycle('monthly')}
                        >
                            Monthly
                        </button>
                        <button
                            className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${billingCycle === 'yearly' ? 'bg-slate-900 text-white shadow-lg' : 'text-slate-500'}`}

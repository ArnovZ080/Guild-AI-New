                ...
                {!submitted ? (
                        ...
                        <CardContent className="pb-12 px-8">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <Button className="w-full h-14 rounded-xl bg-gradient-to-r from-sky-600 to-emerald-600 font-bold text-lg hover:scale-105 transition-transform">
                                    Get Early Access <Send className="ml-2 w-5 h-5" />
                                </Button>
                            </form>
                    ...
                    <Card className="rounded-3xl border-slate-800 bg-slate-950 text-white shadow-2xl text-center p-12">
                        ...
                        <div className="p-6 bg-slate-900 rounded-2xl border border-slate-800 mb-8">
                            ...
                            <p className="text-slate-300">Share Guild AI with a friend to skip 100 spots.</p>
                        </div>
                        <Link to="/"><Button variant="ghost" className="text-slate-400"><ArrowLeft className="mr-2" /> Back to Home</Button></Link>
                    </Card>
                )}
            </div>
        </div>

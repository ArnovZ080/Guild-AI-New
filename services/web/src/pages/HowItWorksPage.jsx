...
function HowItWorksPage() {
  ...
  const steps = [
    ...
    {
        step: '02',
        title: 'Guild creates your content - checked before you see it',
        description: 'Blog posts, social media updates, reels, email newsletters, ad creatives - all written and designed in your exact brand voice, formatted correctly for each platform. Before any of it reaches you, Guild\'s quality layer checks every piece for brand consistency, factual accuracy, SEO alignment, and ideal customer fit. You only ever review content that has already passed quality control.',
        detail: 'This is what makes Guild different from every other AI content tool. No prompting. No filtering. No fixing generic output. What reaches your queue is already ready to publish.'
    },
    {
        step: '03',
                ...
                {steps.map((s, i) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="p-3 rounded-2xl bg-indigo-500/10 border border-indigo-400/40 shadow-glow-sm text-indigo-400">
                                {i === 0 && <Brain size={24} />}
                        ...
                        <div className="pt-6 border-t border-white/5">
                            <p className="text-sm uppercase tracking-widest font-black text-indigo-300 mb-2">Worth Knowing</p>
                            <p className="text-sm text-zinc-300 font-medium leading-relaxed italic">{s.detail}</p>
                        </div>
                    </motion.div>
                ))}
            </div>

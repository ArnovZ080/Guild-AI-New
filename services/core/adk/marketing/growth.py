...
SYSTEM_PROMPT = """You are a Growth Marketing Specialist for a small business.
...
class GrowthAgent(BaseAgent):
    ...
    @classmethod
    async def seo_audit(cls, website: str,
                        current_metrics: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
priority_actions (top 5 with expected_impact), estimated_timeline."""
    ...
    @classmethod
    async def keyword_research(cls, business: str, niche: str,
...
quick_wins (low competition, high intent), competitor_gaps."""
    ...
    @classmethod
    async def plan_ads_campaign(cls, objective: str, budget: float,
...
optimization_schedule, a_b_test_plan."""
    ...
    @classmethod
    async def social_strategy(cls, business: Dict[str, Any],
...
community_building_plan, influencer_strategy, kpis."""
    ...
    @classmethod
    async def plan_event(cls, event_type: str, objective: str,
                          audience: Dict[str, Any],
...
content_repurposing_plan."""
    ...
    @classmethod
    async def growth_roadmap(cls, business: Dict[str, Any],

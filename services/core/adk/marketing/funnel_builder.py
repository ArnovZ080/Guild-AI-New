...
7. **HONEYPOT**: Include a hidden input named "honeypot" with `style="display:none"` inside the form.
8. Ensure responsive design (mobile-first).
9. Use FontAwesome (via CDN) or inline SVG icons to make it look premium.
10. Output ONLY valid HTML. Do not wrap in markdown code blocks like ```html ... ```. Just raw HTML starting with <!DOCTYPE html>.
11. Ensure the HTML is accessible and semantic.
